/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/cbuild/slaves/oort12/crosstool-ng/builds/arm-linux-gnueabihf-linux/.build/src/gcc-linaro-4.7-2012.05/gcc/config/arm/arm.md'.  */
